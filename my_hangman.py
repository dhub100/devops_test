"""Hangman game with farm vocabulary."""
import random
...
def load_words_from_file(filename):
    ...
    try:
        ...
        raise RuntimeError(f"Datei '{filename}' wurde nicht gefunden.") from exc
...
class PoolOfWords:
    ...
    def next_word(self):
        """Gibt ein zufälliges, noch nicht verwendetes Wort zurück."""
        candidates = [
    ...
    @property
    def used_words(self):
        """Gibt eine sortierte Liste der verwendeten Wörter zurück."""
...
class HangmanRound:
    ...
    def try_letter(self, letter):
        """Verarbeitet einen einzelnen Buchstabenversuch und gibt True zurück,
        wenn er im geheimen Wort enthalten."""
        letter = letter.lower()
    ...
    def guess_word(self, attempt):
        """Verarbeitet einen Versuch und gibt True zurück, wenn er mit dem
        geheimen Wort übereinstimmt."""
